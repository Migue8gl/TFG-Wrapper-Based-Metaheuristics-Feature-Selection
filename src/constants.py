...
DEFAULT_ITERATIONS = 3  # Analisys iterations for each optimizer
DEFAULT_MAX_ITERATIONS = 2  # For analisys comparison between optimizers
DEFAULT_POPULATION_SIZE = 2  # Vector solution length
