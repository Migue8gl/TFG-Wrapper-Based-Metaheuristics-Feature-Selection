...
\begin{itemize}
      ...
      \item \textbf{Servidor} Para la experimentación del proyecto se ha hecho uso de un servidor para ejecutar las distintas pruebas de los algoritmos. Se estima el precio por mes y total dada una estimación de los servicios de \textit{Google Cloud - Compute Engine}\\[6pt]
            \begin{table}[H]
                  \centering
